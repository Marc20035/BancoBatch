...
@Entity
@Table(name = "LoteProcesamientoes")
...
public class LoteProcesamiento {
    ...
    @OneToMany(mappedBy = "loteProcesamientoId")
    private Set<TransaccionBancaria> transaccionBancarias;

    @OneToMany(mappedBy = "loteProcesamientoId3")
    private Set<TransaccionBancaria> transaccionBancarias3;
